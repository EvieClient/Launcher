...
const logger = new Logger("bgExpressServer");
...
app.listen(9998, () => {
  logger.info("listening on port 9998");
});
...
app.get("/auth/microsoft", async (req, res) => {
  ...
  logger.info(`Reqeust recived for /auth/microsoft`);
...
app.get("/allgood", (req, res) => {
  logger.info(`Reqeust recived for /allgood`);
